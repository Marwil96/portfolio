    ...
    return (
        <div className="aboutContainer" id="aboutContainer">
          <div className="aboutTextContainer"> 
            ...
            <p className="pTextStyle"> I’m William Martinsson, a designer who knows how to code from Gothenburg, Sweden. I’m currently studying digital design at YRGO. <br/><br/>
